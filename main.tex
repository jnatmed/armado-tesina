...
\usepackage{times}
\usepackage{graphicx}
\graphicspath{{figuras/}{codigo/figuras/}}
...
\input{pseudocodigos/1_alpha_dbasmote}

\subsubsection{Pseudocódigo: \textit{ar\_adasyn}}
\input{pseudocodigos/2_ar_adasyn}

\subsubsection{Pseudocódigo: \textit{alpha\_dbasmote\_ar\_adasyn}}
\input{pseudocodigos/3_alpha_dbasmote_ar_adasyn}

\subsubsection{Pseudocódigo: \textit{PC\_SMOTE}}
\input{pseudocodigos/4_pc_smote.tex}

\input{pseudocodigos/41_pc_smote_descripcion.tex}


\input{pseudocodigos/resultados_comparativos.tex}
