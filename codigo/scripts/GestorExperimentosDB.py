...
class GestorExperimentosDB:
    ...
    def get_or_create_config_id(self, tecnica: str, densidad, riesgo, pureza, tipo: str) -> int:
        """
        Inserta o recupera la configuración de sobremuestreo.
        """
        sql = (
            "INSERT INTO `configuracion_sobremuestreo` "
    ...
    def upsert_experimento_y_metricas(
        ...
        """
        Inserta o actualiza el experimento y sus métricas.
        """
        sql = (
            ...
            "`cv_splits`=VALUES(`cv_splits`),"
            "`n_iter`=VALUES(`n_iter`),"
            "`n_jobs_search`=VALUES(`n_jobs_search`),"
            "`search_time_sec`=VALUES(`search_time_sec`),"
            "`mejor_configuracion`=VALUES(`mejor_configuracion`),"
